...
====================================
[rewrite_local]
^https?:\/\/api\.x-storm\.com\/app\/user-profile\/$ url script-response-body https://raw.githubusercontent.com/G-kok/X/main/Scripts/StormSniffer.js
...
if (url == 'https://api.x-storm.com/app/user-profile/') {
	var uid = headers["uid"];
	var time = headers["t"];
    var str = '{"uid": "' + uid + '", "userID": 276549, "isVip": 1, "member_type": 2, "member_title": "\u7EC8\u8EAB\u7248\A", "expire_on": "\u6C38\u4E45", "auth_quantity": 0, "auth_mail": "null", "is_primary": 0, "trail_status": 0, "function_list": [1, 2, 3, 4, 5], "can_deauthorize": true, "timestamp": ' + time + ', "ts": 1}';
